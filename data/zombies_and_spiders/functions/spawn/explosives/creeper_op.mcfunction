...
execute if score count spawnCreeperOp matches 1 run summon creeper ~ ~ ~ {powered:1,Tags:["axolotvengance","not_op"],Passengers:[{CustomName:'{"text":"Fulminant Drakxolot","color":"dark_purple"}',id:axolotl}],Fuse:1, ExplosionRadius:10}
